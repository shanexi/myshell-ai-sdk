...
// import { content_blocks_to_mdc } from './content-blocks-to-mdc';

// export const RemarkDefaultMessage = () => {
//   const lines = [
//     // content_blocks_to_mdc(demo_default_message_1),
//     // content_blocks_to_mdc(demo_default_message_2),
//     // content_blocks_to_mdc(demo_default_message_3),
