...
import { Cell as u, Signal as x, map as p, filter as m, withLatestFrom as S, scan as se, debounceTime as be, mapTo as F, throttleTime as Ft, delayWithMicrotask as Bt, onNext as tn, Action as _t, useCellValue as C, useRealm as Ht, Realm as ho, RealmContext as go, useCellValues as mo } from "@virtuoso.dev/gurx";
import h from "react";
function Ie(e, t) {
  const n = u(e, (o) => {
    o.link(t(o), n);
...
function B(e, t, n) {
  return I(e) ? nn(t, n, 1) : t === e.k ? M(e, { k: t, v: n }) : t < e.k ? qt(M(e, { l: B(e.l, t, n) })) : qt(M(e, { r: B(e.r, t, n) }));
}
function $t(e, t, n) {
  if (I(e))
    return [];
  ...
  let l = [];
  return o > t && (l = l.concat($t(s, t, n))), o >= t && o <= n && l.push({ k: o, v: i }), o <= n && (l = l.concat($t(r, t, n))), l;
}
function bo(e, t, n, o) {
  if (I(e))
    return Te;
...
function vo(e, t, n) {
  ...
  for (const { start: s, end: r, value: l } of Io(e))
    s < t ? (o = B(o, s, l), i = l) : s > t + n ? o = B(o, s - n, l) : r >= t + n && i !== l && (o = B(o, t, l));
  return o;
}
function ve(e) {
...
function et(e) {
  ...
  if (xt(e))
    return wt(M(e, { lvl: o - 1 }));
  if (!I(n) && !I(n.l)) {
    const i = n.l, s = xt(i) ? n.lvl - 1 : n.lvl;
    return M(i, {
      l: M(e, {
        lvl: o - 1,
        r: i.l
...
function wt(e) {
  const { r: t, lvl: n } = e;
  return !I(t) && !I(t.r) && t.lvl === n && t.r.lvl === n ? M(t, { l: M(e, { r: t.l }), lvl: n + 1 }) : e;
}
function cn(e) {
  const { l: t } = e;
...
function lt(e, t, n, o = 0) {
  let i = e.length - 1;
  for (; o <= i; ) {
    const s = Math.floor((o + i) / 2), r = e[s], l = n(r, t);
    if (l === 0)
      return s;
    if (l === -1) {
      if (i - o < 2)
...
function To(e, t, n, o = 0) {
  return o > 0 && (t = Math.max(t, an(e, o, Wt).offset)), t = Math.max(0, t), ln(ko(e, t, n, So), xo);
}
const ye = [[], 0, 0, 0];
function yo(e, [t, n]) {
  let o = 0, i = 0, s = 0, r = 0;
  if (n !== 0) {
    ...
    const c = ae(t, n - 1);
    o = c[0], i = c[1], e.length && e[r].height === ae(t, n)[1] && (r -= 1), e = e.slice(0, r + 1);
  } else
    e = [];
...
function $o(e, t) {
  ...
  for (const o of t) {
    ...
    for (const { start: g, end: b, value: v } of l)
      c ? (r >= g || i === v) && (e = Et(e, g)) : (a = v !== i, c = !0), b > r && r >= g && v !== i && (e = B(e, r + 1, v));
    a && (e = B(e, s, i));
  }
  return [e, n];
}
...
function wo(e, [t, n]) {
  if (n.length > 0 && I(e) && t.length === 2) {
    ...
    return [
      n.reduce((s, r) => B(B(s, r, o), r + 1, i), Me()),
      0
    ];
  }
  return $o(e, t);
...
const In = "up", Tt = "down", Ro = "none", Mo = {
  atBottom: !1,
...
const de = u(!1), No = x((e) => {
  ...
  e.link(e.pipe($, Gt(1), F(!0)), We), e.link(e.pipe($, Gt(1), F(!1), be(100)), We);
}), Rt = u(!1, (e) => {
    ...
    e.link(
      e.pipe(
        ...
        se((t, [n, o, i, s, r, l]) => {
          ...
          if (a) {
            let v, T;
            return o > t.state.scrollTop ? (v = "SCROLLED_DOWN", T = t.state.scrollTop - o) : (v = n === i ? "LIST_TOO_SHORT" : "SIZE_DECREASED", T = t.state.scrollTop - o || t.scrollTopDelta), {
              atBottom: !0,
              state: g,
              atBottomBecause: v,
              scrollTopDelta: T
  ...
  e.link(
    e.pipe(
      $,
      se(
        (t, n) => e.getValue(Rt) ? { direction: t.direction, prevScrollTop: n } : { direction: n < t.prevScrollTop ? In : Tt, prevScrollTop: n },
  ...
  e.link(e.pipe(We, m(bn), F(0)), Zt), e.link(
    e.pipe(
      $,
      Ft(100),
      S(We),
...
function yn({
  ...
  s -= l + c;
  let k = Lt(v, n) + r - l;
  a === "end" ? k = k - s + T() : a === "center" && (k = k - s / 2 + T() / 2), b && (k += b);
  let d = 0;
  return a === "start" && (d = Math.max(0, Math.min(k - (o - s)))), k = Math.max(0, k), { top: k, behavior: g, align: a, forceBottomSpace: d };
}
const De = u(null), Do = u(!1), nt = u(!0), Mt = x((e) => {
  e.link(
    e.pipe(
      Mt,
      p(() => !0)
  ...
  e.link(
    e.pipe(
      ...
      p(([t, n, o, i]) => {
        ...
        const a = typeof t != "number" ? t.done : void 0, [g, b] = gn(c, o);
        return g < -i.listOffset ? ((typeof t == "number" || t.align === void 0) && (s = "start-no-overflow"), { index: c, align: s, behavior: r, offset: l, done: a }) : g + b > -i.listOffset + i.visibleListHeight ? ((typeof t == "number" || t.align === void 0) && (s = "end"), { index: c, align: s, behavior: r, offset: l, done: a }) : null;
      }),
      m((t) => t !== null)
    ),
  ...
  e.link(te, De), e.link(t, Re), e.link(
    e.pipe(
      te,
    ...
    de
  ), e.link(e.pipe(t, F(!1)), nt), e.link(e.pipe(t, F(!1)), Do), e.link(
    e.pipe(
      G,
...
// ssr render all initialValues
function CoX(e, t) {
  return t.reduce((acc, cur, curIdx) => {
    acc.push(Co(curIdx, t)[0])
    return acc
  }, [])
}
function Co(e, t) {
...
const Fo = [], Ce = {
    ...
    e.pipe(
      ...
      se(
        (t, [
          ...
          if (I(i)) {
            let X = 0;
            return g !== null && (X = Pt(g, r - 1).index), { ...Ce, items: CoX(X, c), offsetTree: s, totalCount: r, data: c };
          }
          let W = 0;
          b !== null && n === 0 && (W = yn({
            totalHeight: l,
          ...
          let U = 0;
          e.getValue($) !== 0 && !e.getValue(Ye) && e.getValue(ut) === In && t.totalCount === r && t.items.length > 0 && (U = l - t.totalHeight, U !== 0 && (U += e.getValue(Tn)));
          const P = Math.min(
            Math.max(
              n + W + a - d - v + U,
              0
          ...
          if (t.offsetTree === s && t.totalCount === r && t.data === c && P >= t.listTop && J <= t.listBottom)
            return t;
          const Y = [], ne = r - 1, y = 0, le = To(s, P, J, y);
          let D = 0, Ge = 0, w = !1;
          for (const X of le) {
            const {
            ...
            let Q = X.start;
            D = Se, Se < P && (Q += Math.floor((P - Se) / ie), D += (Q - X.start) * ie), Q < y && (D += (y - Q) * ie, Q = y);
          ...
          const oe = l - D, bt = ((fe = Y[0]) == null ? void 0 : fe.offset) || 0;
          return { items: Y, listBottom: D, listTop: Ge, offsetTree: s, paddingBottom: oe, paddingTop: bt, totalCount: r, totalHeight: l, data: c, deviationDelta: U };
        },
        Ce
      )
    ),
  ...
  e.link(
    ...
    ot
  ), mn() ? (e.sub(e.pipe(ot, S(H, $)), ([t, n]) => {
    e.pub(H, n - t);
  }), e.sub(
    e.pipe(e.combine($, H, Ee, _e)),
    ([t, n, o, i]) => {
      o || i || (n > 0 && t < n ? (e.pub(q, !0), e.pub(Re, { top: 0, behavior: "instant" }), setTimeout(() => {
        e.pubIn({
          [q]: !1,
          [H]: 0
        });
    ...
    ([, t]) => {
      e.pub(q, !0), t < 0 ? requestAnimationFrame(() => {
        e.pub(re, -t), e.pub(H, 0), requestAnimationFrame(() => {
          e.pub(q, !1);
        });
...
}, !1), $ = u(0), Z = u(0), $n = u(0), j = u(0), Bo = $, it = u(0), Ke = u(0), je = u(0), Ue = u(0), zt = u(0), At = u(null), wn = _t(), _o = Lo, Ho = 50, ht = Ie(0, (e) => e.pipe(
  e.combine(Ke, je),
  p(([t, n]) => t + n)
)), Ln = Ie(0, (e) => e.pipe(
  e.combine(Ue, zt),
  ...
  (e) => e.pipe(
    ...
    p(
      ([
        ...
        const v = e.getValue(Sn), T = r - n - o, k = -t + i, d = T + Math.min(0, k) - s - l;
        return {
          scrollHeight: T,
          listOffset: k,
          visibleListHeight: s,
...
}), re = x(), H = u(0), st = u(0), at = u(0), An = u(""), Kt = x(), On = _t(), Nn = _t();
function Yo(e, t) {
  var r, l;
  const n = t.slice();
  let o = 0;
  ...
  for (const { k: c, v: a } of ve(e)) {
    for (; n.length && n[0] < c; )
      n.shift(), o++;
    const g = Math.max(0, c - o), b = ((r = i.at(-1)) == null ? void 0 : r.k) ?? -1;
    g === b ? (((l = i.at(-2)) == null ? void 0 : l.v) ?? -1) === a ? i.pop() : i[i.length - 1].v = a : i.push({ k: g, v: a });
  }
  let s = Me();
...
const ke = u(0), Pe = u(null), L = u(null, (e) => {
  e.link(
    e.pipe(
      L,
      m((t) => t !== null),
  ...
  e.link(
    ...
    H
  ), e.link(e.pipe(ue, F(!0)), _e), e.link(e.pipe(ue, Bt()), Ve);
  function t(n, o) {
    e.pubIn({
      [re]: n,
      [st]: n
  ...
  ), e.changeWith(L, ue, (n, o) => n ? [...o, ...n] : o.slice()), e.link(
    e.pipe(
      ue,
      S(G, $e),
      p(([n, o, i]) => {
        const s = n.length, r = i;
        return ve(o).reduce(
          (c, { k: a, v: g }) => ({
  ...
  const t = e.pipe(
    ...
    p(([{ data: o, scrollToBottom: i }, s, r, l]) => {
      ...
      if (typeof i == "function") {
        const g = i({ data: o, scrollLocation: s, scrollInProgress: r, context: l, atBottom: a });
        if (!g)
          return null;
        if (typeof g == "object")
          return g;
  ...
  e.changeWith(L, pt, (t, n) => t ? [...t, ...n.data] : n.data.slice()), e.link(pt, dt);
}), rt = x((e) => {
  e.changeWith(L, rt, (t, n) => t ? [...t.slice(0, n.offset), ...n.data, ...t.slice(n.offset)] : n.data.slice()), e.changeWith(pe, rt, ([t], n) => {
    const i = ae(t, n.offset, "k")[0], s = n.data.length;
    return [bo(t, i, Number.POSITIVE_INFINITY, (l, c) => [l + s, c]), i];
  }), e.link(rt, dt);
}), Nt = x((e) => {
  e.changeWith(L, Nt, (t, { offset: n, count: o }) => t ? t.slice(0, n).concat(t.slice(n + o)) : []), e.changeWith(pe, Nt, ([t], { offset: n, count: o }) => [vo(t, n, o), n]);
}), yt = u(null), He = x((e) => {
  e.sub(
    e.pipe(
      He,
  ...
  e.changeWith(L, Jt, (t, n) => t ? t.slice(n) : []), e.changeWith(pe, Jt, ([t], n) => [ve(t).reduce((i, { k: s, v: r }) => B(i, Math.max(0, s - n), r), Me()), 0]);
}), Xt = x((e) => {
  e.changeWith(L, Xt, (t, n) => t ? t.slice(0, t.length - n) : []), e.link(
    e.pipe(
      Xt,
      S(ke, $e),
      p(([, t, n]) => [
  ...
  e.changeWith(L, t, (n, o) => n ? n.filter((i, s) => !o.includes(s)) : []), e.changeWith(pe, t, ([n], o) => [Yo(n, o), 0]);
}), Vt = x((e) => {
  e.changeWith(L, Vt, (t, { mapper: n }) => t ? t.map(n) : []), e.link(
    e.pipe(
      Vt,
      vn(3),
      S(xn),
      m(([{ autoscrollToBottomBehavior: t }, n]) => n && !!t),
      p(([{ autoscrollToBottomBehavior: t }]) => typeof t == "object" ? t.location() : { index: "LAST", align: "end", behavior: t }),
      m((t) => !!t)
    ),
    te
  );
}), zo = ({ item: e, ItemContent: t, mount: n, unmount: o, isClient }) => {
  const i = C(Pe), s = h.useRef(null), r = h.useCallback(
    (l) => {
      l ? (s.current = l, n(l)) : s.current && (o(s.current), s.current = null);
    },
    [n, o]
  );
  return /* @__PURE__ */ E(
    "div",
    {
      ...
      style: {
        overflowAnchor: "none",
        position: isClient ? 'absolute' : undefined,
        width: "100%",
        top: e.offset
      },
      children: /* @__PURE__ */ E(t, { index: e.index, prevData: e.prevData, nextData: e.nextData, data: e.data, context: i })
    }
  );
};
function Ko(e) {
...
function Go(e, t) {
  ...
  for (var n = 1732584193, o = -271733879, i = -1732584194, s = 271733878, r = 0; r < e.length; r += 16) {
    const l = n, c = o, a = i, g = s;
    o = V(
      o = V(
        o = V(
          o = V(
            o = N(
              o = N(
                o = N(
                  o = N(
                    o = O(
                      o = O(
                        o = O(
                          o = O(
                            o = A(
                              o = A(
                                o = A(
                                  o = A(
                                    ...
                                    i = A(
                                      i,
                                      s = A(s, n = A(n, o, i, s, e[r + 0], 7, -680876936), o, i, e[r + 1], 12, -389564586),
                                      n,
                                      o,
                                      e[r + 2],
                                      17,
                                  ...
                                  i = A(
                                    i,
                                    s = A(s, n = A(n, o, i, s, e[r + 4], 7, -176418897), o, i, e[r + 5], 12, 1200080426),
                                    n,
                                    o,
                                    e[r + 6],
                                    17,
                                ...
                                i = A(
                                  i,
                                  s = A(s, n = A(n, o, i, s, e[r + 8], 7, 1770035416), o, i, e[r + 9], 12, -1958414417),
                                  n,
                                  o,
                                  e[r + 10],
                                  17,
                              ...
                              i = A(
                                i,
                                s = A(s, n = A(n, o, i, s, e[r + 12], 7, 1804603682), o, i, e[r + 13], 12, -40341101),
                                n,
                                o,
                                e[r + 14],
                                17,
                            ...
                            i = O(
                              i,
                              s = O(s, n = O(n, o, i, s, e[r + 1], 5, -165796510), o, i, e[r + 6], 9, -1069501632),
                              n,
                              o,
                              e[r + 11],
                              14,
                          ...
                          i = O(
                            i,
                            s = O(s, n = O(n, o, i, s, e[r + 5], 5, -701558691), o, i, e[r + 10], 9, 38016083),
                            n,
                            o,
                            e[r + 15],
                            14,
                        ...
                        i = O(
                          i,
                          s = O(s, n = O(n, o, i, s, e[r + 9], 5, 568446438), o, i, e[r + 14], 9, -1019803690),
                          n,
                          o,
                          e[r + 3],
                          14,
                      ...
                      i = O(
                        i,
                        s = O(s, n = O(n, o, i, s, e[r + 13], 5, -1444681467), o, i, e[r + 2], 9, -51403784),
                        n,
                        o,
                        e[r + 7],
                        14,
                    ...
                    i = N(
                      i,
                      s = N(s, n = N(n, o, i, s, e[r + 5], 4, -378558), o, i, e[r + 8], 11, -2022574463),
                      n,
                      o,
                      e[r + 11],
                      16,
                  ...
                  i = N(
                    i,
                    s = N(s, n = N(n, o, i, s, e[r + 1], 4, -1530992060), o, i, e[r + 4], 11, 1272893353),
                    n,
                    o,
                    e[r + 7],
                    16,
                ...
                i = N(
                  i,
                  s = N(s, n = N(n, o, i, s, e[r + 13], 4, 681279174), o, i, e[r + 0], 11, -358537222),
                  n,
                  o,
                  e[r + 3],
                  16,
              ...
              i = N(
                i,
                s = N(s, n = N(n, o, i, s, e[r + 9], 4, -640364487), o, i, e[r + 12], 11, -421815835),
                n,
                o,
                e[r + 15],
                16,
            ...
            i = V(
              i,
              s = V(s, n = V(n, o, i, s, e[r + 0], 6, -198630844), o, i, e[r + 7], 10, 1126891415),
              n,
              o,
              e[r + 14],
              15,
          ...
          i = V(
            i,
            s = V(s, n = V(n, o, i, s, e[r + 12], 6, 1700485571), o, i, e[r + 3], 10, -1894986606),
            n,
            o,
            e[r + 10],
            15,
        ...
        i = V(
          i,
          s = V(s, n = V(n, o, i, s, e[r + 8], 6, 1873313359), o, i, e[r + 15], 10, -30611744),
          n,
          o,
          e[r + 6],
          15,
      ...
      i = V(
        i,
        s = V(s, n = V(n, o, i, s, e[r + 4], 6, -145523070), o, i, e[r + 11], 10, -1120210379),
        n,
        o,
        e[r + 2],
        15,
      ...
      21,
      -343485551
    ), n = ce(n, l), o = ce(o, c), i = ce(i, a), s = ce(s, g);
  }
  return [n, o, i, s];
}
...
function Jo(e) {
  ...
  if (t !== Ko(n))
    return Dn;
  const [i, s] = o.split(";"), r = i.slice(2), l = new Date(Number(s.slice(2)));
...
}, ii = Cn, si = /^(?:127\.0\.0\.1|localhost|0\.0\.0\.0|.+\.local)$/, ri = ["virtuoso.dev", "csb.app", "codesandbox.io"];
function li({ licenseKey: e, now: t, hostname: n, packageTimestamp: o }) {
  const i = n.match(si), s = ri.some((l) => n.endsWith(l));
  if (!e)
    return s ? ii : i ? ei : Qo;
  const r = Jo(e);
  if (r === Dn)
...
const Fn = h.createContext(Xo), ui = ({
  licenseKey: e,
  children: t
}) => {
  const n = li({
...
const ci = h.createContext(void 0), Bn = u(null), _n = u(null), Hn = u(null), Wn = u(null), Pn = u(null), Yn = u("div"), ai = {
  position: "sticky",
  top: 0,
  zIndex: 1
}, Xe = {
  ...
  position: "sticky",
  bottom: 0
}, zn = h.forwardRef((e, t) => /* @__PURE__ */ E("div", { style: { zIndex: 1 }, ...e, ref: t })), Kn = h.forwardRef((e, t) => /* @__PURE__ */ E("div", { ...e, ref: t })), jn = h.forwardRef(
  ({ style: e, ...t }, n) => /* @__PURE__ */ E("div", { ...t, style: { ...ai, ...e }, ref: n })
), Un = h.forwardRef(
  ({ style: e, ...t }, n) => /* @__PURE__ */ E("div", { ...t, style: { ...pi, ...e }, ref: n })
), qn = u(zn), Gn = u(jn), Zn = u(Kn), Jn = u(Un), Xn = ({ index: e }) => /* @__PURE__ */ en("div", { children: [
  "Item ",
  e
] }), Qn = ({ index: e }) => e, Dt = u(Xn), eo = u(Qn), Ct = u("top", (e) => {
  e.link(
    e.pipe(
...
function fi(e, t, n) {
  const o = Ht(), i = h.useRef(null), s = h.useRef(null), r = h.useCallback(() => {
    i.current && (cancelAnimationFrame(i.current), i.current = null, s.current = null);
  }, []);
  h.useEffect(() => o.sub(Kt, (a) => {
    a !== s.current && r();
  }), [o, r]), h.useEffect(() => o.sub(wn, r), [o, r]);
  const l = h.useCallback(
    (a, g, b) => {
      ...
      function d() {
        var P, J;
        const U = v + (a - v) * g(T);
        (P = e.current) == null || P.scrollTo({ top: U, behavior: "instant" }), T += 1 / b, k += 1, k < b ? i.current = requestAnimationFrame(d) : ((J = e.current) == null || J.scrollTo({ top: a, behavior: "instant" }), i.current = null, s.current = null);
      }
      d();
    },
    [e, r]
  ...
  return h.useCallback(
    (a) => {
      ...
      if (a.top !== void 0 && (n.current = a.top, o.pub(Yt, !0)), a.forceBottomSpace !== void 0 && t.current && (t.current.style.paddingBottom = `${a.forceBottomSpace}px`), a.behavior === "smooth")
        l(a.top ?? 0, _o, Ho);
      else if (a.behavior === "auto" || a.behavior === "instant" || a.behavior === void 0)
        r(), (v = e.current) == null || v.scrollTo(a);
      else {
        const { easing: k, animationFrameCount: d } = a.behavior(((T = e.current) == null ? void 0 : T.scrollTop) ?? 0, a.top ?? 0);
        l(a.top ?? 0, k, d);
      }
    },
    [o, l, t, e, n, r]
...
function to(e) {
  return {
    data: {
      ...
      batch: (t, n) => {
        e.pub(Ee, !0), t(), e.pub(Ee, !1), e.pub(dt, { data: [], scrollToBottom: n });
      },
...
const hi = h.forwardRef(
  ({
    ...
    const Y = h.useMemo(() => {
      const y = new ho();
      return y.register(Oe), y.register(Ye), y.register(ut), y.register(ot), y.register(tt), y.register(pt), y.register(ue), y.register(He), y.pubIn({
        [L]: e.slice(),
        [Pe]: n,
        [eo]: t,
        [Le]: o,
        ...
        [qn]: T,
        [Ct]: i
      }), y.singletonSub(Ot, s), y.singletonSub(ct, r), y;
    }, []);
    h.useImperativeHandle(J, () => to(Y), [Y]), h.useEffect(() => {
      Y.pubIn({
        [Pe]: n,
        [Dt]: l
      }), Y.singletonSub(Ot, s), Y.singletonSub(ct, r);
    });
    const ne = h.useContext(Fn);
    return h.useEffect(() => {
      ne.consoleMessage && (Qt || (Qt = !0, console.warn(ne.consoleMessage)));
    }, [ne]), h.useEffect(() => {
      const y = (le) => {
        var D;
        (D = le.message) != null && D.includes("ResizeObserver loop") && (le.preventDefault(), le.stopPropagation(), le.stopImmediatePropagation());
      };
      return window.addEventListener("error", y, { capture: !0 }), () => {
        window.removeEventListener("error", y);
      };
    }, []), typeof window < "u" && ne.watermarkMessage ? /* @__PURE__ */ E(
      "div",
      {
        style: {
          color: "red",
    ...
    ) : /* @__PURE__ */ E(go.Provider, { value: Y, children: /* @__PURE__ */ E(gi, { ...P }) });
  }
);
hi.displayName = "VirtuosoMessageList";
const gi = ({ style: e, ...t }) => {
  const n = Ht(), o = h.useContext(ci), [
    i,
    s,
    r,
    l,
    ...
    if (!(typeof ResizeObserver > "u"))
      return new ResizeObserver((f) => {
        ...
        for (let It = 0; It < z; It++) {
          ...
          if (K.dataset.index === void 0)
            continue;
          const kt = Number.parseInt(K.dataset.index), po = Number.parseFloat(K.dataset.knownSize ?? ""), St = ge.contentRect.height;
          if (St === po)
            continue;
          const Ut = _[_.length - 1];
          _.length === 0 || Ut.size !== St || Ut.endIndex !== kt - 1 ? _.push({ endIndex: kt, size: St, startIndex: kt }) : _[_.length - 1].endIndex++;
        }
        _.length > 0 && (R = {
          ...R,
          [me]: _
  ...
  }), [W, U] = Qe(d), [P, J] = Qe(d), [Y, ne] = Qe(d), [y, le] = Qe(d), D = h.useCallback(
    (f) => {
      if (o) {
    ...
    [d]
  ), w = h.useRef(null), oe = h.useRef(null), bt = h.useCallback(
    (f) => {
      f ? (oe.current = f, d == null || d.observe(f, { box: "border-box" })) : oe.current && (d == null || d.unobserve(oe.current), oe.current = null);
    },
    [d]
  ), fe = h.useRef(null), X = fi(w, oe, fe), Se = h.useCallback((f) => {
    ...
    if (f !== null) {
      if (fe.current !== null) {
        ...
        dn(f.scrollTop, Math.min(z, fe.current)) && (fe.current = null, n.pub(Yt, !1), n.pub(ze, f.scrollTop));
      }
      n.pub($, f.scrollTop);
    }
  }, [n]), Q = h.useCallback(
    ...
    (f) => {
      f ? (n.pub(At, f), w.current = f, f.addEventListener("scroll", ie), f.addEventListener("wheel", Q), o && n.pubIn({
        [Z]: o.viewportHeight,
        [j]: o.viewportHeight,
        [$]: 0
      }), d == null || d.observe(f, { box: "border-box" })) : w.current && (w.current.removeEventListener("scroll", ie), w.current.removeEventListener("wheel", Q), n.pub(At, null), d == null || d.unobserve(w.current), w.current = null);
    },
    [d, n, ie, Q, o]
  ), { items: ee } = C(Oe);
  h.useLayoutEffect(() => {
  ...
  }, [n]), h.useLayoutEffect(() => n.sub(Re, X), [X, n]), h.useLayoutEffect(() => n.sub(re, Se), [Se, n]);
  const Ze = h.useCallback(() => {
    ...
    for (const _ of ((z = oe.current) == null ? void 0 : z.children) ?? []) {
      if (_.dataset.index === void 0)
        continue;
      const R = Number.parseInt(_.dataset.index), Je = Number.parseFloat(_.dataset.knownSize ?? ""), xe = _.getBoundingClientRect().height;
      if (xe === Je)
        continue;
      const Ne = f[f.length - 1];
      f.length === 0 || Ne.size !== xe || Ne.endIndex !== R - 1 ? f.push({ endIndex: R, size: xe, startIndex: R }) : f[f.length - 1].endIndex++;
    }
    n.pub(me, f);
  }, [n]);
  h.useLayoutEffect(() => n.sub(On, Ze), [Ze, n]);
  const no = C(H), oo = C(st), io = C(q), so = C(at), ro = C(gt), lo = C(An), he = C(Pe), uo = C(eo), co = C(ke), ao = C(Ae);
    // see [two-pass rendering](https://react.dev/reference/react-dom/client/hydrateRoot#handling-different-client-and-server-content)
    const [isClient, setIsClient] = h.useState(false)
    h.useEffect(() => {
      setIsClient(true);
    }, [])
  return h.useLayoutEffect(() => {
    ee.length === 0 && n.pub(Nn);
  }, [ee, n]), /* @__PURE__ */ E(fo, { children: /* @__PURE__ */ en(
    k,
    {
      ...t,
      ref: vt,
      ...
      ...k === "div" ? { context: he } : {},
      children: [
        s && /* @__PURE__ */ E(l, { ref: y, style: Xe, children: /* @__PURE__ */ E(s, { context: he }) }),
        i && /* @__PURE__ */ E(r, { ref: Y, style: Xe, children: /* @__PURE__ */ E(i, { context: he }) }),
        co > 0 ? /* @__PURE__ */ E(
          "div",
          {
            ref: bt,
        ...
        ) : T ? /* @__PURE__ */ E(T, { context: he }) : null,
        c && /* @__PURE__ */ E(g, { ref: W, style: Xe, children: /* @__PURE__ */ E(c, { context: he }) }),
        a && /* @__PURE__ */ E(b, { ref: P, style: Xe, children: /* @__PURE__ */ E(a, { context: he }) })
      ]
    }
  ) });
};
