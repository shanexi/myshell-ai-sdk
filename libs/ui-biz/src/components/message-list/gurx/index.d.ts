...
export declare function AsyncQuery<I, O>(
  query: (params: I) => Promise<O>,
  defaultParams: I,
 ...
 * @category Nodes
 */
export declare function Cell<T>(
  value: T,
  init?: (r: Realm) => void,
  distinct?: Distinct<T>,
): NodeRef<T>;
 ...
 * @category Nodes
 */
export declare function DerivedCell<T>(
  value: T,
 ...
 * @category Operators
 */
export declare function filter<I, O = I>(
 ...
 * @category Operators
 */
export declare function handlePromise<I, OutSuccess, OnLoad, OutError>(
  onLoad: () => OnLoad,
...
export declare function Pipe<I, O>(
  value: O,
...
export declare type PipeInit<I, O> = (
  r: Realm,
  inputRef$: NodeRef<I>,
  outputRef$: NodeRef<O>,
) => void;
...
export declare type ProjectionFunc<T extends unknown[] = unknown[]> = (
...
export declare class Realm {
  ...
  combineCells<T1, T2, T3>(
    ...nodes: [Out<T1>, Out<T2>, Out<T3>]
  ): Out<[T1, T2, T3]>;
  combineCells<T1, T2, T3, T4>(
    ...nodes: [Out<T1>, Out<T2>, Out<T3>, Out<T4>]
  ): Out<[T1, T2, T3, T4]>;
 ...
 * @category React Components
 */
export declare function RealmProvider({
  children,
  initWith,
  updateWith,
}: {
 ...
 * @category Operators
 */
export declare function scan<I, O>(
  accumulator: (current: O, value: I) => O,
  seed: O,
): Operator<I, O>;
 ...
 * @category Hooks
 */
export declare function useCell<O, I = O>(
  cell: NodeRef<O> | PipeRef<I, O>,
): [O, (value: I) => void];
...
export declare function useCellValues<T1, T2>(
  ...cells: [Out<T1>, Out<T2>]
): [T1, T2];

export declare function useCellValues<T1, T2, T3>(
  ...cells: [Out<T1>, Out<T2>, Out<T3>]
): [T1, T2, T3];

export declare function useCellValues<T1, T2, T3, T4>(
  ...cells: [Out<T1>, Out<T2>, Out<T3>, Out<T4>]
): [T1, T2, T3, T4];

export declare function useCellValues<T1, T2, T3, T4, T5>(
  ...cells: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>]
): [T1, T2, T3, T4, T5];

export declare function useCellValues<T1, T2, T3, T4, T5, T6>(
  ...cells: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>, Out<T6>]
): [T1, T2, T3, T4, T5, T6];

export declare function useCellValues<T1, T2, T3, T4, T5, T6, T7>(
  ...cells: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>, Out<T6>, Out<T7>]
): [T1, T2, T3, T4, T5, T6, T7];

export declare function useCellValues<T1, T2, T3, T4, T5, T6, T7, T8>(
  ...cells: [
    Out<T1>,
    Out<T2>,
    Out<T3>,
...
export declare function useCellValues<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
  ...cells: [
    Out<T1>,
    Out<T2>,
    Out<T3>,
...
export declare function useCellValues<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
  ...cells: [
    Out<T1>,
    Out<T2>,
    Out<T3>,
...
export declare function useCellValues<
  T1,
  T2,
  T3,
  T4,
 ...
 * @category Operators
 */
export declare function withLatestFrom<I, T1>(
  ...nodes: [Out<T1>]
): (source: Out<I>) => NodeRef<[I, T1]>;

export declare function withLatestFrom<I, T1, T2>(
  ...nodes: [Out<T1>, Out<T2>]
): (source: Out<I>) => NodeRef<[I, T1, T2]>;

export declare function withLatestFrom<I, T1, T2, T3>(
  ...nodes: [Out<T1>, Out<T2>, Out<T3>]
): (source: Out<I>) => NodeRef<[I, T1, T2, T3]>;

export declare function withLatestFrom<I, T1, T2, T3, T4>(
  ...nodes: [Out<T1>, Out<T2>, Out<T3>, Out<T4>]
): (source: Out<I>) => NodeRef<[I, T1, T2, T3, T4]>;

export declare function withLatestFrom<I, T1, T2, T3, T4, T5>(
  ...nodes: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>]
): (source: Out<I>) => NodeRef<[I, T1, T2, T3, T4, T5]>;

export declare function withLatestFrom<I, T1, T2, T3, T4, T5, T6>(
  ...nodes: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>, Out<T6>]
): (source: Out<I>) => NodeRef<[I, T1, T2, T3, T4, T5, T6]>;

export declare function withLatestFrom<I, T1, T2, T3, T4, T5, T6, T7>(
  ...nodes: [Out<T1>, Out<T2>, Out<T3>, Out<T4>, Out<T5>, Out<T6>, Out<T7>]
): (source: Out<I>) => NodeRef<[I, T1, T2, T3, T4, T5, T6, T7]>;

export declare function withLatestFrom<I, T1, T2, T3, T4, T5, T6, T7, T8>(
  ...nodes: [
    Out<T1>,
    Out<T2>,
    Out<T3>,
...
): (source: Out<I>) => NodeRef<[I, T1, T2, T3, T4, T5, T6, T7, T8]>;
