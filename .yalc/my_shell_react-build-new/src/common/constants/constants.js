...
exports.chainIdMap = {
    [SupportedChain.Ethereum]: chains_1.mainnet.id,
    [SupportedChain.BSC]: exports.bsc_chain_id_current_env,
    [SupportedChain.OpBNB]: chains_1.opBNB.id,
    [SupportedChain.MyShell_Testnet]: wagmi_1.MyshellTest.id
};
