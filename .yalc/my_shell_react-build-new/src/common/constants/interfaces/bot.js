export var KnowledgeSourceStatusEnum;
...
})(KnowledgeSourceStatusEnum || (KnowledgeSourceStatusEnum = {}));
export var AsrLangTypeEnum;
(function (AsrLangTypeEnum) {
    AsrLangTypeEnum["English"] = "English";
    AsrLangTypeEnum["Mixed"] = "Mixed";
})(AsrLangTypeEnum || (AsrLangTypeEnum = {}));
export var ModeTypeEnum;
...
export var DevModeTypeEnum;
(function (DevModeTypeEnum) {
    DevModeTypeEnum["PRO"] = "PRO_CONFIG_MODE";
    DevModeTypeEnum["API"] = "API_MODE";
})(DevModeTypeEnum || (DevModeTypeEnum = {}));
export var ConversationScenario;
...
export var ImageGenMessageType;
...
})(ImageGenMessageType || (ImageGenMessageType = {}));
