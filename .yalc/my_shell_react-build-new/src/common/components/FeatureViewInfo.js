...
function FeatureViewInfoLayout({ coverImageUrl, overview, title, bot, widget, onClose, isPopup = true, children, clickCallback, featureType, from }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: (0, clsx_1.default)(`top-0 left-0 bg-surface z-[10] w-full h-full flex-1 flex flex-col p-0 md:p-2 overflow-hidden`, {
            absolute: isPopup
        }), children: [(0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)('flex items-center w-full h-[56px] md:h-[72px] px-4 py-2.5 md:px-5 md:py-[18px] md:rounded-t-[24px]', isMobile ? 'absolute top-0 right-0' : 'border-b border-default bg-surface'), children: [onClose && ((0, jsx_runtime_1.jsxs)(link_1.default, { className: "flex justify-center items-center text-[16px] font-semibold text-on-surface cursor-pointer", href: `${isMobile ? '/m' : ''}/explore`, children: [(0, jsx_runtime_1.jsx)("div", { className: "flex justify-center items-center float-right bg-surface-default rounded-full z-[1] w-9 h-9 md:w-6 md:h-6", children: (0, jsx_runtime_1.jsx)(ArrowLeftIcon_1.default, { className: "text-icon md:stroke-primary w-[22px] h-[22px] md:w-6 md:h-6" }) }), !isMobile && (0, jsx_runtime_1.jsx)("div", { className: "h-[20px] w-[1px] mx-3 border-r border-default" })] })), !isMobile && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center text-xl leading-[1.3] text-default pr-8 line-clamp-2 truncate", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-default text-lg md:text-xl", children: title }), bot?.isOfficial && ((0, jsx_runtime_1.jsx)(tooltip_1.Tooltip, { description: chatT('official_bot'), children: (0, jsx_runtime_1.jsx)(CheckBadgeIcon_1.default, { className: "w-[24px] h-[24px] leading-[1.3] fill-primary cursor-pointer" }) }))] }))] }), (0, jsx_runtime_1.jsx)("div", { className: "w-full h-full flex-col md:flex-row flex bg-surface overflow-y-auto md:overflow-hidden rounded-b-[24px]", children: (0, jsx_runtime_1.jsxs)("div", { className: "w-full flex flex-col md:flex-row", children: [isMobile ? ((0, jsx_runtime_1.jsx)(FeatureOverview, { ...overview, bot: bot, widget: widget, featureType: featureType, clickCallback: clickCallback, from: from })) : ((0, jsx_runtime_1.jsx)("div", { className: "bg-surface w-full flex justify-center items-center md:w-[50%] bg-[#F6F6F7] dark:bg-[#323339]", style: {
