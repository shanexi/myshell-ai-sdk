...
const switchThumbVariants = cva('pointer-events-none block rounded-full bg-surface-default ring-0 transition-transform data-[state=unchecked]:translate-x-0', {
    variants: {
        size: {
...
const Switch = React.forwardRef(({ className, size, ...props }, ref) => (_jsx(SwitchPrimitives.Root, { className: cn(switchRootVariants({ size, className }), className), ...props, ref: ref, children: _jsx(SwitchPrimitives.Thumb, { className: cn(switchThumbVariants({ size })) }) })));
