...
const EyeSlashIcon_1 = __importDefault(require("@heroicons/react/24/outline/esm/EyeSlashIcon"));
const clsx_1 = __importDefault(require("clsx"));
const throttle_1 = __importDefault(require("lodash-es/throttle"));
const navigation_1 = require("next/navigation");
const next_intl_1 = require("next-intl");
const react_1 = require("react");
const NotFoundIcon_1 = __importDefault(require("../../common/components/icons/NotFoundIcon"));
...
const image_1 = require("../../common/components/ui/image");
...
const useRestoreScrollPosition_1 = require("../../common/hooks/useRestoreScrollPosition");
...
const GalleryAuthorInfo_1 = __importDefault(require("./GalleryAuthorInfo"));
const GalleryShareBtn_1 = __importDefault(require("./GalleryShareBtn"));
const GalleryInfoSkeleon_1 = __importDefault(require("../../../app/(pc)/gallery/[botId]/[galleryId]/GalleryInfoSkeleon"));
