...
const ChatShare_1 = __importDefault(require("../../chat/views/chat-share/ChatShare"));
const separator_1 = require("../../common/components/ui/separator");
const EditorSkeleton_1 = __importDefault(require("./editor/skeleton/EditorSkeleton"));
const MessageListSkeleton_1 = __importDefault(require("./message-list/skeleton/MessageListSkeleton"));
const useNewChatStore_1 = require("../services/useNewChatStore");
const Editor = (0, dynamic_1.default)(() => Promise.resolve().then(() => __importStar(require('./editor'))), {
    loading: () => (0, jsx_runtime_1.jsx)(EditorSkeleton_1.default, {}),
    ssr: false
});
const MessageList = (0, dynamic_1.default)(() => Promise.resolve().then(() => __importStar(require('./message-list'))), {
    loading: () => (0, jsx_runtime_1.jsx)(MessageListSkeleton_1.default, {}),
    ssr: false
});
function ChatModule({ bgUrl, editorAnchorRef, editorContainerRef, textareaRef, topActionsSlot, scrollLayoutToTop, showMobileDetail, otherModeSlot }) {
