...
const audio_recorder_1 = require("./components/audio-recorder");
const audio_input_1 = require("./components/audio-recorder/audio-input");
const file_list_1 = __importDefault(require("./components/file-list"));
const file_uploader_1 = require("./components/file-uploader");
const menu_list_1 = __importDefault(require("./components/function-menu/menu-list"));
const send_button_1 = require("./components/send-button");
const text_input_1 = require("./components/text-input");
const MobileTextInput_1 = require("./components/text-input/MobileTextInput");
