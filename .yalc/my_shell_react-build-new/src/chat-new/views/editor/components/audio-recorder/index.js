...
const ArrowUpIcon_1 = __importDefault(require("@heroicons/react/24/outline/esm/ArrowUpIcon"));
...
const StopIcon_1 = __importDefault(require("@heroicons/react/24/solid/esm/StopIcon"));
const XMarkIcon_1 = __importDefault(require("@heroicons/react/24/solid/esm/XMarkIcon"));
const clsx_1 = __importDefault(require("clsx"));
const next_intl_1 = require("next-intl");
const react_1 = require("react");
const react_use_1 = require("react-use");
const KeyboardIcon_1 = __importDefault(require("../../../../../common/components/icons/KeyboardIcon"));
const icon_button_1 = require("../../../../../common/components/ui/icon-button");
const common_helper_1 = require("../../../../../common/utils/common-helper");
const count_down_tips_1 = __importDefault(require("./count-down-tips"));
const useRecorder_1 = __importStar(require("./hooks/useRecorder"));
const menu_list_1 = __importDefault(require("../function-menu/menu-list"));
