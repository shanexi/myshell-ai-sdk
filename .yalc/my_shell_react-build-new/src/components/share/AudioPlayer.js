...
function AudioPlayer(props) {
    ...
    const curDuration = props.blobDuration || 0;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)('audio-player pb-3 leading-7 flex flex-col justify-start items-start', {
        ...
        }), children: [props.showProgressBar && ((0, jsx_runtime_1.jsx)("div", { className: "bg-primary h-[1px] w-full items-start", style: { width: `${(0, common_helper_1.getPercent)(currentTime, curDuration) * 100}%` } })), (0, jsx_runtime_1.jsx)("div", { className: "w-full mt-2 pl-3", children: audioHasError ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex space-x-[4px] items-center px-[4px]", children: [(0, jsx_runtime_1.jsx)(XCircleIcon_1.default, { className: "w-[20px] h-[20px] stroke-[#F62ECA]" }), (0, jsx_runtime_1.jsx)("span", { className: "text-on-surface", children: t('audio_cannot_load') })] })) : ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-start space-x-2 text-xs", children: [(0, jsx_runtime_1.jsx)(react_1.IconButton, { onClick: handleAudioToggle, w: "20px", h: "20px", minW: "20px", borderRadius: "50%", className: "bg-primary", _hover: {
