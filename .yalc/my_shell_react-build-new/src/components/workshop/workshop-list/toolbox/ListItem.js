...
function ListItem({ botInfo, selectedType, selectedId }) {
    ...
    const isSelected = (0, react_1.useMemo)(() => {
        return selectedType === 'toolbox' && selectedId === botInfo.id;
    }, [botInfo.id, selectedId, selectedType]);
    return ((0, jsx_runtime_1.jsxs)("div", { id: `toolbox-${botInfo.id}`, className: (0, clsx_1.default)('w-full rounded-xl overflow-hidden p-3 flex space-x-2 items-center text-default', isSelected ? 'bg-surface-accent-blue-subtler' : 'bg-transparent hover:bg-surface-container-hovered'), children: [(0, jsx_runtime_1.jsx)("div", { className: "w-fit shrink-0 relative", children: (0, jsx_runtime_1.jsx)(avatar_1.Avatar, { size: isMobile ? '2xl' : 'xl', src: botInfo.logoUrl
                        ? (0, common_helper_1.getAssetsUrlV2)(botInfo.logoUrl)
                        : 'https://image.myshell.ai/image/bot/logo/20240106/default.png', alt: "bot avatar" }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col grow overflow-hidden space-y-1 md:space-y-0.5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between items-center", children: [(0, jsx_runtime_1.jsxs)("div", { className: "w-full max-w-[86%] flex items-center space-x-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "truncate", children: (0, jsx_runtime_1.jsx)("span", { children: botInfo.name }) }), botInfo?.isOfficial && ((0, jsx_runtime_1.jsx)(tooltip_1.Tooltip, { description: chatT('official_bot'), children: (0, jsx_runtime_1.jsx)(CheckBadgeIcon_1.default, { className: "w-4 h-4 fill-icon-brand" }) }))] }), (0, jsx_runtime_1.jsx)("span", { className: (0, clsx_1.default)('text-xs leading-[14px] shrink-0 text-subtlest'), children: botLastMessage
                                    ...
                                    : '' })] }), (0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)('w-full text-sm overflow-hidden flex items-center space-x-1 space-x-0.5', selectedType === 'toolbox' && selectedId === botInfo.id ? 'text-white' : 'text-secondary'), children: [!!botInfo.allTagList.slice(0, 1).length &&
