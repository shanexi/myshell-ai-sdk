...
function NoEnergyModal({ onConfirm, onClose, isOpen }) {
    ...
    }, [handleUseProp, onConfirm, usableEnergyPack]);
    return ((0, jsx_runtime_1.jsxs)(react_1.Modal, { isOpen: isOpen, onClose: onClose, isCentered: true, children: [(0, jsx_runtime_1.jsx)(react_1.ModalOverlay, {}), (0, jsx_runtime_1.jsxs)(react_1.ModalContent, { p: "16px", rounded: "24px", className: "bg-surface", children: [(0, jsx_runtime_1.jsx)(react_1.ModalHeader, { p: 0, pt: "4px", children: (0, jsx_runtime_1.jsx)(react_1.Box, { p: 2, children: (0, jsx_runtime_1.jsx)(image_1.default, { src: lowBattery_svg_1.default, alt: "low battery", className: "w-[40px] h-[40px]", style: {
