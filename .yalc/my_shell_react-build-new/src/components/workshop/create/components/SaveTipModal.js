...
function SaveTipModal({ isOpen, onClose, onConfirmed }) {
    ...
    (0, react_2.useEffect)(() => {
        ...
        timerRef.current = setTimeout(() => {
            sensors?.track('SaveUnsavedContent', {
                bot_id: currentForm.botId,
                bot_name: currentForm.name
            });
        }, 3000);
        return () => {
            if (timerRef.current) {
