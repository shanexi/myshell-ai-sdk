...
function ShareBtn({ type, id, trackerFn }) {
    ...
    return ((0, jsx_runtime_1.jsx)(tooltip_1.Tooltip, { showArrow: false, disabled: isMobile, description: t('share'), children: (0, jsx_runtime_1.jsx)(icon_button_1.IconButton, { loading: generating, variant: "ghost", size: "md", onClick: copyShareLinkHandle, icon: ArrowUpOnSquareIcon_1.default, className: "text-brand" }) }));
}
