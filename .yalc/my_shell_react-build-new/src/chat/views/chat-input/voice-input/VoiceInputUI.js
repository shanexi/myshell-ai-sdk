...
const CountdownTips_1 = __importDefault(require("./component/CountdownTips.js"));
const useVoiceInput_1 = __importDefault(require("./useVoiceInput.js"));
const FunctionMenu_1 = __importDefault(require("../function-menu/FunctionMenu.js"));
function VoiceInputUI({ onSend, selectedBot, userSelectVoiceRef, isMobile, isWorkshop = false, allowTextInput = true }) {
    const { audioPlayer, state, sending, disabled, setInputType, handleSend, afterPlayEnd, clearRecord, stopRecording, handlePlay, handleStartRecording, placeholder } = (0, useVoiceInput_1.default)({
        onSend,
        selectedBot,
        userSelectVoiceRef,
        isMobile,
    ...
    const { scrollLayoutToTop } = (0, react_1.useContext)(context_1.default);
