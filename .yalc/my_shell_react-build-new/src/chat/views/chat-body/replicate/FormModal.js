...
const Checkbox_1 = __importDefault(require("./Checkbox.js"));
const CustomNumberInput_1 = __importDefault(require("./CustomNumberInput.js"));
const CustomSelect_1 = __importDefault(require("./CustomSelect.js"));
const CustomTextarea_1 = __importDefault(require("./CustomTextarea.js"));
const FileUpload_1 = __importDefault(require("./FileUpload.js"));
const GetImageInfoModal_1 = __importDefault(require("./GetImageInfoModal.js"));
const NumberSlider_1 = __importDefault(require("./NumberSlider.js"));
const SaveTipModal_1 = __importDefault(require("./SaveTipModal.js"));
function RenderForm(props) {
    ...
    if (Com) {
        ...
        return ((0, jsx_runtime_1.jsxs)(react_1.FormControl, { className: (0, clsx_1.default)('relative', formEle.wrapperClass), children: [formEle.name && ((0, jsx_runtime_1.jsxs)(react_1.FormLabel, { htmlFor: formEle.id, className: "mb-1.5 text-[14px]", children: [formEle.isRequired && (0, jsx_runtime_1.jsx)("span", { className: "text-[#EC2F0D] mr-[2px]", children: "*" }), formEle.name] })), formEle.description && ((0, jsx_runtime_1.jsx)(react_1.FormLabel, { htmlFor: formEle.id, className: "mb-1.5 text-[14px] text-secondary", children: formEle.description })), (0, jsx_runtime_1.jsx)("div", { className: (0, clsx_1.default)('flex flex-row justify-between items-center'), children: (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: formEle.id, control: control, rules: formEle.rules, render: ({ field }) => {
                            ...
                            return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(Com, { ...rest, ...(formEle?.props || {}), ...options, ...extFiledName, type: formEle.type, supportedFileTypes: formEle.supportedFileTypes, fileUploadSizeMaximum: formEle?.fileUploadSizeMaximum, ref: ref, onChange: (data) => {
                                        onValueChange(data);
                                        ...
                                        'w-full border-default hover:border-hovered focus:outline focus:outline-variant focus-visible:border-pressed focus-visible:outline-offset-0 focus-visible:outline-utility-status04-70s04-70 focus-visible:shadow-none rounded-[12px]', formEle.class) }) }));
                        } }) })] }, formEle.id));
    }
    return null;
}
function FormModal({ imagePanelParams, setOpen, scrollToBottom, isMobile, botInfo }) {
    ...
    const componentsFunction = botInfo?.imComponent.componentsFunction || [];
    ...
    const onSubmit = async (values) => {
        ...
        sensors?.track('ClickGenerate', {
            bot_id: botInfo?.id,
            bot_name: botInfo?.name,
            battery_cost: batteryCost,
            popup_type: imagePanelParams?.componentInput ? 'ParameterPopUp' : 'StartPopUp'
        });
    };
    ...
    const batteryCost = botInfo?.imComponent.energyConsumePerUse;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_1.Modal, { isOpen: imagePanelParams?.visible, isCentered: true, onClose: handleDrawerClose, size: isMobile ? 'full' : '', children: (0, jsx_runtime_1.jsx)(react_1.ModalOverlay, { className: "bg-alpha-mask-desktop", children: (0, jsx_runtime_1.jsxs)(react_1.ModalContent, { className: (0, clsx_1.default)('max-w-[768px] max-h-[620px] m-0 bg-surface rounded-[24px] flex items-center', isMobile ? 'rounded-none' : ''), style: {
                            boxShadow: '0px 0px 40px 0px rgba(0, 0, 0, 0.10)'
                                        ...
                                        }) })), !isMobile && (0, jsx_runtime_1.jsx)("p", { className: "text-sm", children: botInfo?.imComponent?.description })] }), (0, jsx_runtime_1.jsx)("div", { className: "w-full px-6 py-3 overflow-y-auto text-on-surface flex-grow", children: (0, jsx_runtime_1.jsx)("form", { onSubmit: handleSubmit(onSubmit), id: "hook-form", className: "space-y-4", children: componentsInput.map((formEle, index) => {
                                        ...
                                        }, children: [chatT('panel.generate'), (0, jsx_runtime_1.jsxs)("div", { className: "ml-1.5 flex flex-row justify-center items-center", children: [(0, jsx_runtime_1.jsx)("img", { src: "/icons/thunder.svg", alt: "thunder", className: "w-4 h-4" }), (0, jsx_runtime_1.jsx)("span", { className: "text-xs font-semibold text-white ml-[2px]", children: botInfo?.imComponent.energyConsumePerUse })] })] })] })] }) }) }), componentsFunction?.map((item) => {
                if (item.functionName === 'getImageInfo') {
                    return ((0, jsx_runtime_1.jsx)(GetImageInfoModal_1.default, { imagePanelParams: imagePanelParams, watch: watch, reset: reset, getValues: getValues, isMobile: isMobile, isOpen: isModalOpen, setModaOpen: setModaOpen, botInfo: botInfo }, item.functionName));
                }
