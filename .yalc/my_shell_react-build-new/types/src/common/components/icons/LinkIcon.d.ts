declare const LinkIcon: import("react").ForwardRefExoticComponent<import("react").HTMLAttributes<HTMLSpanElement> & import("class-variance-authority").VariantProps<(props?: ({
