/* eslint-disable @typescript-eslint/no-empty-function, @typescript-eslint/ban-ts-comment, require-yield */

// copy from https://github.com/koskimas/kysely-d1/blob/main/src/index.ts
// because the original package did not support esm
import {
  CompiledQuery,
  DatabaseConnection,
